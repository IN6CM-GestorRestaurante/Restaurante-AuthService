...
namespace Restaurante.AuthService.Infrastructure.Data
{
    public static class DataSeeder
    {
        public static async Task SeedAsync(AuthDbContext context, IPasswordHasher passwordHasher, IConfiguration configuration)
        {
            ...
            // Clientes Pollo Campero (App Móvil)
            users.Add(CreateUser("e00000000000000000000019", "Cliente", "Campero", "ccampero", "cliente@campero.com", "55511120", "CLIENT", camperoCompanyId, null, defaultUserPass));
            users.Add(CreateUser("e0000000000000000000001a", "Fernando", "Alvarez", "falvarez", "cliente.vip@campero.com", "55511121", "CLIENT", camperoCompanyId, camperoBranch1Id, defaultUserPass));
            users.Add(CreateUser("e0000000000000000000001b", "Gabriela", "Mendoza", "gmendoza", "cliente.frecuente@campero.com", "55511122", "CLIENT", camperoCompanyId, camperoBranch2Id, defaultUserPass));
            ...
            // Clientes Mc Donalds (App Móvil)
            users.Add(CreateUser("e00000000000000000000029", "Cliente", "McDo", "cmcdo", "cliente@mcdonalds.com", "55522230", "CLIENT", mcdoCompanyId, null, defaultUserPass));
            users.Add(CreateUser("e0000000000000000000002a", "Rodrigo", "Paz", "rpaz", "cliente.vip@mcdonalds.com", "55522231", "CLIENT", mcdoCompanyId, mcdoBranch1Id, defaultUserPass));
            users.Add(CreateUser("e0000000000000000000002b", "Valeria", "Solano", "vsolano", "cliente.frecuente@mcdonalds.com", "55522232", "CLIENT", mcdoCompanyId, mcdoBranch2Id, defaultUserPass));

            // Cliente General Universal (App Móvil)
            users.Add(CreateUser("e00000000000000000000030", "Martin", "Garces", "mgarces", "cliente@restaurante.local", "55533333", "CLIENT", camperoCompanyId, null, defaultUserPass));
